...
namespace App::Ui::User
{
	...
	{		
		...
		if(shouldMakeNewAsset)
		{
			...
			state->SetFrontend(MakeUnique<AssetCreationDialogFrontend>(*app, currentPath.string(), [&b = wasNewAssetCreated](){ b = true; }));
