...
{
	class SetPipelineStateCommand final : public DX12Command
	{
		private: ResourceHandle::t_hash pipeline;

		
		
		public: SetPipelineStateCommand(ResourceHandle::t_hash pipeline);
