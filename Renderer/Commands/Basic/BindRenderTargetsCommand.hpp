...
{
	class BindRenderTargetsCommand final : public DX12Command
	{
		private: ResourceHandle::t_hash windowSurface;

		private: ResourceHandle::t_hash depthTargetDescriptor;


		
		public: BindRenderTargetsCommand(ResourceHandle::t_hash windowSurface, ResourceHandle::t_hash depthTarget);
