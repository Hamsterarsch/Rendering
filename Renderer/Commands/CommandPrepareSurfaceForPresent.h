...
namespace Renderer::DX12
{
	...
	class CommandPrepareSurfaceForPresent final : public RenderCommand
	{
		private: RenderSurface surface;


		
		public: CommandPrepareSurfaceForPresent(const RenderSurface &surface) : surface{ surface } {}
		...
		{
			surface.RecordPresentPreparations(*list);
