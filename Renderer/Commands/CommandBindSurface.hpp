...
namespace Renderer::DX12
{
	...
	class CommandBindSurface final : public RenderCommand
	{
		private: RenderSurface surface;


		
		public: CommandBindSurface(const RenderSurface &surface) : surface{ surface } {}
		...
		{
			surface.RecordBindSurfaces(*list);
