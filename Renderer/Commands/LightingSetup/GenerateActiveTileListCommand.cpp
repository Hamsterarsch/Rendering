...
namespace Renderer::DX12::Commands
{
	...
	(
		...
		tileFlags{ &factory, factory.MakeUavBuffer(nullptr, lightGridTileCount * sizeof(unsigned)) },
		activeTileList{ &factory, factory.MakeUavBuffer(nullptr, sizeof(unsigned)*(lightGridTileCount+1)) },
		activeTileCount{ 0 },
